...
public class HomeScreenFromCategoriesScreenUIAutomatorTest {
    @Rule
    public final ActivityTestRule<CategoriesActivity> main = new ActivityTestRule<>(CategoriesActivity.class);
    @Test
    public void homeScreenTest() throws UiObjectNotFoundException, RemoteException{
        try {
            ...
            Thread.sleep(2000);
            UiObject bank = new UiObject(new UiSelector().description("Categories"));
            bank.click();
            Thread.sleep(5000);
        }
